    ...
    >
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex justify-center gap-6 text-[30px] mt-4">
          <Link to="docs"><MdDocumentScanner></MdDocumentScanner></Link>
          <Link to="support"><MdContactSupport></MdContactSupport></Link>
          <Link to="feedback"><MdFeedback></MdFeedback></Link>
        </div>
